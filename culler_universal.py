...
def cull_universal(folder, fast, cache_dir, csv_file, move_deletes, use_ollama, ollama_model, verbose, detail, extensions, override):
    """
    ...
    # Post-process results for XMP metadata and CSV
    xmp_created = 0
